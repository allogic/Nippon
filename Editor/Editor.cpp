...
static void ImGuiSetupIo()
{
	...
	static ImWchar glyphRanges[] =
	{
		...
		0xF0214, 0xF0214, // ICON_MDI_FILE
		0xF022A, 0xF022A, // ICON_MDI_FILE_SEND
		0xF0645, 0xF0645, // ICON_MDI_FILE_TREE
		0xF0770, 0xF0770, // ICON_MDI_FOLDER_OPEN
		0xF0836, 0xF0836, // ICON_MDI_TABLE_OF_CONTENTS
		0xF0900, 0xF0900, // ICON_MDI_PLAYLIST_EDIT
		0xF09AA, 0xF09AA, // ICON_MDI_TEXT_LONG
		0xF0574, 0xF0574, // ICON_MDI_VIEW_QUILT
		0xF0CFF, 0xF0CFF, // ICON_MDI_DATABASE_SYNC
		0xF0D00, 0xF0D00, // ICON_MDI_DATABASE_REMOVE
		0xF0D01, 0xF0D01, // ICON_MDI_DATABASE_SETTINGS
		0,
	};
