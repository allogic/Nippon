		...
		for (auto const& model : sceneAssets->GetModels())
		{
			...
			for (auto const& mesh : model.GetScrMeshes())
			{
				...
				for (auto const& subMesh : mesh.SubMeshes)
				{
					...
					std::vector<DefaultVertex> vertices = VertexConverter::ScrToDefault(subMeshEntity, subMesh.Vertices, subMesh.TextureMaps, subMesh.TextureUvs, subMesh.ColorWeights);
